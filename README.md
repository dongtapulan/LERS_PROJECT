...
LERS is a specialized web application developed for the CTU IT Department to manage, track, and reserve laboratory hardware. The system emphasizes physical accountability through automated document generation and strict borrowing policies.
